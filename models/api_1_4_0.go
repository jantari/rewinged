...
func (ver API_ManifestVersion_1_4_0) GetDefaultLocale() API_DefaultLocaleInterface {
    return ver.DefaultLocale
}

func (ver API_ManifestVersion_1_4_0) GetLocales() []API_LocaleInterface {
...
func (ver API_ManifestVersion_1_4_0) GetInstallers() []API_InstallerInterface {
...
func (in *API_Installer_1_4_0) GetInstallerSha() string {
    return in.InstallerSha256
}

func (in *API_Installer_1_4_0) GetInstallerUrl() string {
    return in.InstallerUrl
}

func (in *API_Installer_1_4_0) SetInstallerUrl(newUrl string) {
