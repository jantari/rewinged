...
// All of these definitions are based on the v1.7.0 manifest schema specifications:
// https://github.com/microsoft/winget-cli/tree/master/schemas/JSON/manifests/v1.7.0

// A singleton manifest can only describe one package version and contain only one locale and one installer
// Schema: https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.singleton.1.7.0.json
type Manifest_SingletonManifest_1_7_0 struct {
    ...
    Documentations []Manifest_Documentation_1_7_0 `yaml:"Documentations"`
    Icons []Manifest_Icon_1_7_0 `yaml:"Icons"` // nullable in schema
    NestedInstallerType string `yaml:"NestedInstallerType" json:",omitempty"`
    NestedInstallerFiles []Manifest_NestedInstallerFile_1_7_0 `yaml:"NestedInstallerFiles" json:",omitempty"`
    ReleaseDate string `yaml:"ReleaseDate" json:",omitempty"`
    InstallationMetadata Manifest_InstallationMetadata_1_7_0 `yaml:"InstallationMetadata"`
    Installers [1]Manifest_Installer_1_7_0 `yaml:"Installers"`
    ManifestType string `yaml:"ManifestType"`
    ManifestVersion string `yaml:"ManifestVersion"`
}

func (in *Manifest_SingletonManifest_1_7_0) ToApiManifest() API_ManifestInterface {
  return &API_Manifest_1_7_0{
    PackageIdentifier: in.PackageIdentifier,
    Versions: []API_ManifestVersionInterface{
      &API_ManifestVersion_1_7_0{
        ...
        Installers: []API_Installer_1_7_0{in.Installers[0].ToApiInstaller()},
      },
    },
  }
}
...
// https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.version.1.7.0.json
type Manifest_VersionManifest_1_7_0 struct {
    PackageIdentifier string `yaml:"PackageIdentifier"`
    PackageVersion string `yaml:"PackageVersion"`
...
func (vm Manifest_VersionManifest_1_7_0) GetPackageVersion() string {
    return vm.PackageVersion
}

// The struct for a separate installer manifest file
// https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.installer.1.7.0.json
type Manifest_InstallerManifest_1_7_0 struct {
    PackageIdentifier string `yaml:"PackageIdentifier"`
    PackageVersion string `yaml:"PackageVersion"`
    ...
    InstallerSwitches Manifest_InstallerSwitches_1_7_0 `yaml:"InstallerSwitches"`
    InstallerSuccessCodes []int64 `yaml:"InstallerSuccessCodes" json:",omitempty"`
    ExpectedReturnCodes []Manifest_ExpectedReturnCode_1_7_0 `yaml:"ExpectedReturnCodes" json:",omitempty"`
    ...
    Dependencies Manifest_Dependencies_1_7_0 `yaml:"Dependencies" json:",omitempty"`
    ...
    Installers []Manifest_Installer_1_7_0 `yaml:"Installers"`
...
func (instm Manifest_InstallerManifest_1_7_0) ToApiInstallers() []API_InstallerInterface {
  var apiInstallers []API_InstallerInterface

  for _, installer := range instm.Installers {
    var installer_API_ExpectedReturnCodes []API_ExpectedReturnCode_1_7_0
    for _, erc := range installer.ExpectedReturnCodes {
      installer_API_ExpectedReturnCodes = append(installer_API_ExpectedReturnCodes, API_ExpectedReturnCode_1_7_0(erc))
    }
    var instm_API_ExpectedReturnCodes []API_ExpectedReturnCode_1_7_0
    for _, erc := range instm.ExpectedReturnCodes {
      instm_API_ExpectedReturnCodes = append(instm_API_ExpectedReturnCodes, API_ExpectedReturnCode_1_7_0(erc))
    }

    var installer_API_NestedInstallerFiles []API_NestedInstallerFile_1_7_0
    for _, nif := range installer.NestedInstallerFiles {
        installer_API_NestedInstallerFiles = append(installer_API_NestedInstallerFiles, API_NestedInstallerFile_1_7_0(nif))
    }
    var instm_API_NestedInstallerFiles []API_NestedInstallerFile_1_7_0
    for _, nif := range instm.NestedInstallerFiles {
        instm_API_NestedInstallerFiles = append(instm_API_NestedInstallerFiles, API_NestedInstallerFile_1_7_0(nif))
    }

    apiInstallers = append(apiInstallers, &API_Installer_1_7_0 {
      ...
      InstallerSwitches: API_InstallerSwitches_1_7_0(nonDefault(installer.InstallerSwitches, instm.InstallerSwitches)), // Can be converted directly as they're identical structs
      ...
      Dependencies: API_Dependencies_1_7_0(nonDefault(installer.Dependencies, instm.Dependencies)),
      ...
      InstallationMetadata: API_InstallationMetadata_1_7_0(nonDefault(installer.InstallationMetadata, instm.InstallationMetadata)),
...
type Manifest_Installer_1_7_0 struct {
    InstallerLocale string `yaml:"InstallerLocale" json:",omitempty"`
    ...
    InstallerSwitches Manifest_InstallerSwitches_1_7_0 `yaml:"InstallerSwitches"`
    InstallerSuccessCodes []int64 `yaml:"InstallerSuccessCodes" json:",omitempty"`
    ExpectedReturnCodes []Manifest_ExpectedReturnCode_1_7_0 `yaml:"ExpectedReturnCodes"`
    UpgradeBehavior string `yaml:"UpgradeBehavior" json:",omitempty"`
    Commands []string `yaml:"Commands" json:",omitempty"`
    Protocols []string `yaml:"Protocols" json:",omitempty"`
    FileExtensions []string `yaml:"FileExtensions" json:",omitempty"` 
    Dependencies Manifest_Dependencies_1_7_0 `yaml:"Dependencies"`
    PackageFamilyName string `yaml:"PackageFamilyName" json:",omitempty"`
...
func (mi Manifest_Installer_1_7_0) ToApiInstaller() API_Installer_1_7_0 {
  var installer_API_ExpectedReturnCodes []API_ExpectedReturnCode_1_7_0
  ...
  return API_Installer_1_7_0 {
    ...
    InstallerSwitches: API_InstallerSwitches_1_7_0(mi.InstallerSwitches), // Can be converted directly as they're identical structs
    ...
    Dependencies: API_Dependencies_1_7_0(mi.Dependencies),
    ...
    InstallationMetadata: API_InstallationMetadata_1_7_0(mi.InstallationMetadata),
...
// https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.locale.1.7.0.json
type Manifest_LocaleManifest_1_7_0 struct {
    PackageIdentifier string `yaml:"PackageIdentifier"`
    PackageVersion string `yaml:"PackageVersion"`
    PackageLocale string `yaml:"PackageLocale"`
    Publisher string `yaml:"Publisher"`
    ...
    Description string `yaml:"Description"`
    Tags []string `yaml:"Tags"`
    Agreements []Manifest_Agreement_1_7_0 `yaml:"Agreements"`
    ReleaseNotes string `yaml:"ReleaseNotes"`
    ReleaseNotesUrl string `yaml:"ReleaseNotesUrl"`
    Icons []Manifest_Icon_1_7_0 `yaml:"Icons"` // nullable in schema
}

func (locm Manifest_LocaleManifest_1_7_0) ToApiLocale() API_LocaleInterface {
  var apiAgreements []API_Agreement_1_7_0
  for _, ma := range locm.Agreements {
    apiAgreements = append(apiAgreements, API_Agreement_1_7_0(ma))
  }

  var apiIcons []API_Icon_1_7_0
  for _, mi := range locm.Icons {
      apiIcons = append(apiIcons, API_Icon_1_7_0(mi))
  }

  return API_Locale_1_7_0{
...
// https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.defaultLocale.1.7.0.json
// It is the same as Locale except with an added Moniker
type Manifest_DefaultLocaleManifest_1_7_0 struct {
    PackageIdentifier string `yaml:"PackageIdentifier"`
    PackageVersion string `yaml:"PackageVersion"`
    PackageLocale string `yaml:"PackageLocale"`
    Publisher string `yaml:"Publisher"`
...
func (locm Manifest_DefaultLocaleManifest_1_7_0) ToApiDefaultLocale() API_DefaultLocaleInterface {
  var apiAgreements []API_Agreement_1_7_0
  for _, ma := range locm.Agreements {
    apiAgreements = append(apiAgreements, API_Agreement_1_7_0(ma))
  }
  ...
  return API_DefaultLocale_1_7_0{
    PackageLocale: locm.PackageLocale,
    Publisher: locm.Publisher,
    PublisherUrl: locm.PublisherUrl,
    PublisherSupportUrl: locm.PublisherSupportUrl,
...
type Manifest_InstallerSwitches_1_7_0 struct {
...
type Manifest_ExpectedReturnCode_1_7_0 struct {
...
// https://github.com/microsoft/winget-cli/blob/master/schemas/JSON/manifests/v1.7.0/manifest.installer.1.7.0.json
type Manifest_Dependencies_1_7_0 struct {
...
type Manifest_Documentation_1_7_0 struct {
    DocumentLabel string `yaml:"DocumentLabel"`
    DocumentUrl string `yaml:"DocumentUrl"`
}

type Manifest_InstallationMetadata_1_7_0 struct {
...
type Manifest_NestedInstallerFile_1_7_0 struct {
    RelativeFilePath string `yaml:"RelativeFilePath"`
